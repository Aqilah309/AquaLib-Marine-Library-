...
$dbname = "swadahdb";//database name to access
$dbuser = "swadahuser";//username to access the database
$dbpass = "swadahpassword";//password the username above
...
*/
$system_identifier = "mydomain.institution.edu";
...
$system_policy_url = "https://mydomain.institution.edu/policy.pdf";
...
$ezproxy_ip = "10.10.1.12";
$ezproxy_appended_domain = "mydomain_institution_edu.ezproxy.institution.edu";//url that appended by ezproxy for this repository. it might look something like this sample url. http or https will not be required.

//admin email
$system_admin_email = "user@gmail.com";

//admin contact disclaimer 
$system_admin_contact_disclaimer = "If you have enquiries with this repository, kindly contact us at <a href='mailto:contactus@gmail.com'>contactus@gmail.com</a> or 01-2345678";

//registered owner
$system_owner = "sWADAH Support Unit";

//helpdesk info for more information
$system_helpdesk_contact = "sWADAH Support Unit support line 01-2345678.";
...
$main_logo = "sw_images/company.png";//default is sw_images/company.png
    $main_logo_width = "250px";//can be px or %
$browser_icon = "sw_images/company_www-icon.png";
$menu_icon = "sw_images/company_big-icon.png";

//intro words below the main logo / html5 enabled. you may use html tag on it to control size etc.
$intro_words = "<div style='margin-top:10px;font-size:12px;'>Welcome to sWADAH Digital Repository. This is developed by Tuanku Bainun Library for all libraries in the world. Welcome.</div>";
...
$allow_guest_access_to_pt = true;//allow guest access to guest document
...
$allow_txt_insert_by_admin = false;//allow text file input to be inserted
...
//user page
$allow_user_to_login = false;//allow user to login to their page, enable the My Account button and Login link

//show admin login link on start page
$show_admin_login_link = false; //admin login link on meta. if you set this to false, to access is by calling 'in.php'
...
$searcher_show_icon_indicator = false;// show (true) or hide (false) indicators on guest search page for results

//show or hide qr code on item detail page
$show_qr_code_for_item = true;
...
$tag_264_default_ind = "##";
$publisher_as = "Faculty"; //rebrand publisher as  -  this will utilize/repurpose publisher for a different means
...
$enable_oai_pmh = false;//oai-pmh enabler. true = enabled OAI-PMH request, false = disable
...
*/
    ...
    $emailSetFrom = "set_from_this_user@gmail.com";//this is usually an email address, but you can changed it to something else if you want your user to reply to specific email address
    $emailSetFromName = "sWADAH Mailer";
    $emailFooter = "<hr>This is an automated email. Please do not reply to this email. If you have any question regarding your submission, contact us at user@gmail.com";
