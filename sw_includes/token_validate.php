<?php
	...
	if (isset($_POST) && !empty($_POST))
	{
		...
		else
		{
			...
			echo "<div style='text-align:center;margin-top:100px;'><span style='font-size:40px;color:blue;'><strong>405</strong></span><h2>Forbidden: Method Not Allowed</h2><em>sWADAH HTTP Response Code</em></div>";
   			exit;
		}
	}
